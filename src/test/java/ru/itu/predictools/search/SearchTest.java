...
public class SearchTest {
  ...
  public void checkPredictorsSettersAndGetters() throws IOException {
    ...
    search.run("по");
    assertNotNull("reduced alphabet is not empty after search has been performed", search.getReducedAlphabet());
    assertNotNull("next symbols alphabet is not empty search has been performed", search.getNextSymbolAlphabet());
